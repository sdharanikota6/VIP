...
# Load the dataset
csv_path = '/Users/aryangarg/Documents/GitHub/VIP/dataset_with_sentiments.csv'  # Replace with the actual path
...
df_filtered['Average_Score'] = pd.to_numeric(df_filtered['Average_Score'], errors='coerce')
...
plt.scatter(df_filtered['SUE'], df_filtered['Average_Score'], alpha=0.5, s=50) # Increased marker size
...
plt.ylim(df_filtered['Average_Score'].min(), df_filtered['Average_Score'].max())
